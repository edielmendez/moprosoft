	...
	<div class="wrapper">
	    ...
	    <div class="main-panel">
	        ...
	        <div class="content container">
	        	...
	        	<div class="card">
		            <div class="content">
	                    <?php echo form_open('Estudiantes/crear_usuario',array('id'=>'form_nuevo_estudiante')); ?>
	                        <div class="row">
	                            <div class="col-md-5">
	                                <div class="form-group">
	                                    <label>Nombre Completo</label>
	                                    <input type="text" class="form-control border-input"  placeholder="nombre completo" name="nombre" required="" >
	                                </div>
	                            </div>
	                            <div class="col-md-3">
	                                <div class="form-group">
	                                    <label>Username</label>
	                                    <input type="text" class="form-control border-input" id="username" placeholder="username" name="username" required="">
	                                </div>
	                            </div>
	                            <div class="col-md-4">
	                                <div class="form-group">
	                        ...
	                        <div class="row">
	                            ...
	                            <div class="col-md-4">
	                                <div class="form-group">
	                                    <label>Grupo</label>
	                                    <input type="text" class="form-control border-input" placeholder="grupo" name="grupo" required="">
	                                </div>
	                            </div>
	                            <div class="col-md-4">
	                                <div class="form-group">
	                                    ...
	                                    <select name="equipo" id="equipo">
	                                    	<option selected="" disabled=""  value="0">Selecciona un equipo</option>
	                                    	<?php
